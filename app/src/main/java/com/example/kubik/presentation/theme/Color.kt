...
// =========================================
// 1. БАЗОВЫЕ / БРЕНДОВЫЕ ЦВЕТА (Primary)
// =========================================
...
val OnSurfaceVariantText = Color(0xFF62748E)        // Серый текст на фоне карточек (белая)
val OnSurfaceVariantTextDark = Color(0xFF90A1B9)    // Серый на фоне карточек (темная)
...
// =========================================
// 7. СТАТУСЫ (Успех / Ошибка / Открыто)
// =========================================
